package gotopark.buster.chinaLotgen.externaldb;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/gotopark.buster.chinaLotgen/databases/";

    private static String DB_NAME = "lotdb1.db";
