...
import gotopark.buster.chinaLotgen.SelectNum.GridItemView;
import gotopark.buster.chinaLotgen.SelectNum.GridViewAdapter;
...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] numbers2 = ball.getStringArray(array.BlueBall);


        GridView gridView1 = (GridView) findViewById(id.grid);
        GridView gridView2 = (GridView) findViewById(id.grid2);
        ...
        cardArrayAdapter = new OneCardAdapter(getApplicationContext(), R.layout.tab1_lot_list);
        ...
        gridView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (selectedIndex2 > -1) {
                    ...
                    ((GridItemView) v).display(false);
                    selectedStrings_star2.remove((String) parent.getItemAtPosition(position));
...
//                        Click_true = 0;
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedStrings.size() == 6 && selectedStrings_star2.size() == 1 && Click_true == 0) {
                    if (Objects.equals(old_pbnum1, pbnum) && Objects.equals(old_pbnum2, pbnum2)) {
                        Toast.makeText(getApplicationContext(), "相同的号码", Toast.LENGTH_LONG).show();
